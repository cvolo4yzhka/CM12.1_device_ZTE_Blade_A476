...
-include vendor/ZTE/Blade_A476/BoardConfigVendor.mk

# use these headers 
TARGET_SPECIFIC_HEADER_PATH := device/ZTE/Blade_A476/include
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 12001476608
...
# TARGET_KERNEL_SOURCE := kernel/ZTE/Blade_A476
# TARGET_KERNEL_ARCH := arm64
# TARGET_KERNEL_HEADER_ARCH := arm64
# TARGET_KERNEL_CONFIG := cyanogenmod_Blade_A476_defconfig
# TARGET_KERNEL_CROSS_COMPILE_PREFIX := aarch64-linux-android-
# MTK_APPENDED_DTB_SUPPORT := yes
# BOARD_KERNEL_IMAGE_NAME := Image.gz-dtb
 
# prebuild kernel as fallback
TARGET_PREBUILT_KERNEL := device/ZTE/Blade_A476/prebuilt/kernel
...
# system.prop
TARGET_SYSTEM_PROP := device/ZTE/Blade_A476/system.prop

# CyanogenMod Hardware Hooks
BOARD_HARDWARE_CLASS := device/ZTE/Blade_A476/cmhw/
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/ZTE/Blade_A476/bluetooth
...
BOARD_EGL_CFG := device/ZTE/Blade_A476/configs/egl.cfg
BOARD_EGL_WORKAROUND_BUG_10194508 := true

# SELinux
BOARD_SEPOLICY_DIRS := \
       device/ZTE/Blade_A476/sepolicy
...
TARGET_RECOVERY_FSTAB := device/ZTE/Blade_A476/recovery/root/fstab.mt6753
