...
$(call inherit-product-if-exists, vendor/ZTE/Blade_A476/Blade_A476-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/ZTE/Blade_A476/overlay

# Recovery allowed devices
TARGET_OTA_ASSERT_DEVICE := ZTE_Blade_A476
...
ifeq ($(TARGET_PREBUILT_KERNEL),)
	LOCAL_KERNEL := device/ZTE/Blade_A476/prebuilt/kernel
else
...
PRODUCT_COPY_FILES += \
	...
	device/ZTE/Blade_A476/rootdir/init.rc:root/init.rc \
	device/ZTE/Blade_A476/rootdir/init.mt6735.usb.rc:root/init.mt6735.usb.rc \
...
PRODUCT_COPY_FILES += \
	device/ZTE/Blade_A476/rootdir/etc/hostapd_default.conf:system/etc/hostapd/hostapd_default.conf \
